class Scatterplot {
    ...
    vis.chart.append("text")
        ...
        .call(text => {
          text.append("tspan")
              .attr("x", vis.xScale(xMax)-105)
              .style("font-size", "15px")
              .attr("dy", "-1.5em")
              .text("Most Favorable:");
          text.append("tspan")
              .attr("x", vis.xScale(xMax)-85)
              .style("font-size", "11px")
              .attr("dy", "1.2em")
              .text("Tuition is low.");
          text.append("tspan")
          ...
          .on('mouseover', (event,d) => {
            d3.select('#tooltip')
              ...
              .html(`
                ...
                <div><i>${d.state}</i></div>
                <ul>
                  <li> In state tuition: $${d.in_state_total}, Out of state tuition: $${d.out_of_state_total}</li>
                  <li> Average early career salary: $${d.early_career_pay} </li>
                  <li>${d.enrollment} undergraduates</li>
